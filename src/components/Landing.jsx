            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              <div className="absolute inset-0">
                <img
                  ...
                  alt=""
                />
                <div className="absolute inset-0 bg-gradient-to-r from-gray-800 to-indigo-700 mix-blend-multiply" />
              </div>
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">Go2Online</span>
                  <span className="block text-4xl text-indigo-200">
                    
                  </span>
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                Go2Online is a video conferencing platform that utilizes web3 technology, allowing DAO contributors, teams, and groups to host meetings and online events.
                </p>
          ...
          <div className="relative">
            <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
              <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                <div>
                  <div>
                    <span className="h-12 w-12 rounded-md flex items-center justify-center bg-gradient-to-r from-blue-800 to-gray-600">
                      <VideoCameraIcon
                  ...
                  <div className="mt-6">
                    ...
                    Upgrade to the pro plan for unlimited video streams and powerful organization tools for teams, businesses, and organizations
                    </p>
                    <div className="mt-6">
                      <a
                        href="#"
                        className="inline-flex bg-gradient-to-r from-blue-800 to-blue-600 bg-origin-border px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-purple-700 hover:to-indigo-700"
                      >
                        Get started
                      </a>
                    </div>
                  ...
                  <blockquote>
                    <div>
                      <p className="text-base text-gray-500">
                        &ldquo;Go2Online enables us to host important team meetings
                ...
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-6">
                      <a
                        href="#"
                        className="inline-flex bg-gradient-to-r from-blue-800 to-gray-800 bg-origin-border px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-purple-700 hover:to-indigo-700"
                      >
                        Contact Us
                      </a>
                    </div>
        ...
        <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2023 EncodeClub - next video build hack -livepeer
            </p>
          </div>
        </div>
      </footer>
